...
// Source: internal/cacheImpl/orderCache.go

// Package mock_cacheImpl is a generated GoMock package.
package mock_cacheImpl
...
func (m *MockCacheI) Add(key uuid.UUID, value *models.Order) {
	m.ctrl.T.Helper()
